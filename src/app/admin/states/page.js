    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const url = currentState
                ? `/api/admin/states/${currentState._id}`
                : "/api/admin/states";
            const method = currentState ? "PUT" : "POST";
    ...
    const handleDelete = async (id) => {
        ...
        if (result.isConfirmed) {
            try {
                ...
                if (res.ok) {
                    fetchData();
                    showAlert("success", "Deleted!", "State has been deleted.");
                } else {
                    showAlert("error", "Error", "Failed to delete state");
                }
            } catch (error) {
